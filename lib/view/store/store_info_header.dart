...
class _StoreInfoHeaderState extends State<_StoreInfoHeader> {
  ...
  bool changedFavorite = false;
  bool changedNotice = false;
  ...
  void dispose() {
    super.dispose();
    if (changedFavorite) userDataSource.putFavoriteStore(widget.storeData.id);
    if (changedNotice) userDataSource.putNoticeStore(widget.storeData.id);
  }
