      ...
      children: [
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("반반 샌드위치", style: AppTextStyle.heading2Bold),
              SizedBox(height: 8.h),
              Row(
                children: [
                  Text("25%",
                  ...
                  SizedBox(width: 5.w),
                  Text("18,000원", style: AppTextStyle.body2Bold),
                  SizedBox(width: 5.w),
                  Text("24,000",
              ...
              Row(
                children: [
                  SvgPicture.asset("assets/icons/pizza.svg",
                      height: 20.h, width: 20.w),
                  SizedBox(width: 2.w),
                  Text("5개 남음", style: AppTextStyle.body2Medium),
                ],
              ),
            ],
          ),
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.h),
              Text("전달사항 작성", style: AppTextStyle.body2Medium),
              SizedBox(height: 15.h),
              Text("평균 조리 시간", style: AppTextStyle.body1Bold),
              SizedBox(height: 4.h),
              Text("10분", style: AppTextStyle.body2Medium),
            ],
          ),
        ),
      ],
