...
class Topbar extends ConsumerWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    LocalLoginState? currentLoginState;
    if (loginState is LoginStateChanged) {
      currentLoginState = loginState.loginState;
    }
          ...
          child: Row(
            ...
            children: [
              ...
              showCarts
                  ? GestureDetector(
                      onTap: () {
                        if (currentLoginState == LocalLoginState.notLogin ||
                            currentLoginState == LocalLoginState.needJoin) {
                          context.push('/login');
                        } else {
                          context.push('/cart');
                        }
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                homeState.cartItems.length.toString(),
